...
<body>
    ...
    <center><form action="check.php" method="POST" class="form" name="form" id="form1">
        <div><lable class="font_note">&nbsp学　号&nbsp</lable><input type="text" id="input" class="input" name="Id" /></div>
        <div><lable class="font_note">&nbsp支　部&nbsp</lable><input type="banji" id="input" class="input" name="Banji" /></div>
        <div><lable class="font_note">&nbsp用户名&nbsp</lable><input type="text" id="input" class="input" name="UserName" /></div>
        <div><lable class="font_note">&nbsp密　码&nbsp</lable><input type="password" id="input" class="input" name="Password" /></div>
